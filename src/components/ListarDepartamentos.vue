<template>
  ...
  <div>
    <div class="card">
      <div class="card-header">Departamentos<a href="/crearDepartamento" type="button" class="btn btn-lg btn-primary"
          style="margin-left: 35%;">Crear</a>|</div>
            ...
            <tr v-for="Departamento in Departamentos" :key="Departamento.pkDepartamento">
              ...
              <td>
                <div class="btn-group" role="label" aria-label="">
                  ...
                  |<button type="button" v-on:click="EditarDepartamento(Departamento.pkDepartamento)"
